...
const Footer = ({ sidebarOpen, isMobile }) => {
  return (
    <footer className={`bg-boxbg/90 border-t border-iconbg/20 p-3 sm:p-4 lg:p-6 mt-auto backdrop-blur-md shadow-lg shadow-black/20 transition-all duration-500 ease-in-out ${
      sidebarOpen && !isMobile ? 'lg:ml-64' : 'lg:ml-20'
    }`}>
      <div className="container mx-auto max-w-full">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
          <div className="text-center sm:text-left">
            <span className="text-xs sm:text-sm text-textcolor font-light">© 2025 <span className="text-iconbg font-medium">LegalAxis</span>. All rights reserved.</span>
          </div>
