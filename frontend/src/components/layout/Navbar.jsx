            ...
            {isProfileOpen && (
              <div className="absolute top-full right-0 z-50 mt-2 bg-[#222222] border border-[#343535] rounded-xl shadow-lg shadow-black/50 w-48 sm:w-56 py-2">
                <div className="px-4 py-3 border-b border-[#343535]">
                  <span className="block text-sm text-white">{user?.displayName || 'User'}</span>
                  <span className="block text-sm font-medium text-[#f3cf1a] truncate">{user?.email || 'user@example.com'}</span>
                </div>
                <ul className="py-2">
                  <li>
                    <a href="#" className="px-4 py-2 text-sm text-white hover:bg-[#343535] transition-all duration-300 flex items-center">
                  ...
                  <li>
                    <a href="#" className="px-4 py-2 text-sm text-white hover:bg-[#343535] transition-colors duration-300 flex items-center">
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <li>
                    <button 
                      ...
                      className="w-full px-4 py-2 text-sm text-white hover:bg-[#343535] transition-colors duration-300 flex items-center text-left"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
