        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="lg:col-span-2 space-y-6 sm:space-y-8">
            ...
            <div className="bg-[#222222] rounded-2xl p-5 sm:p-6 border border-[#343535] shadow-lg">
              ...
              <div className="space-y-4 sm:space-y-5">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full p-3 rounded-xl bg-[#2a2a2a] border border-[#343535] text-white focus:border-[#f3cf1a] focus:outline-none transition-all duration-300"
            ...
            <div className="bg-[#222222] rounded-2xl p-5 sm:p-6 border border-[#343535] shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 rounded-xl bg-[#2a2a2a] border border-[#343535] hover:border-[#f3cf1a]/30 transition-all duration-300 gap-3">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-[#222222] rounded-2xl p-5 sm:p-6 border border-[#343535] shadow-lg">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-xl bg-[#2a2a2a] border border-[#343535] hover:border-[#f3cf1a]/30 transition-all duration-300 flex items-center">
