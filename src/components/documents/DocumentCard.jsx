const DocumentCard = ({ document }) => {
  ...
  const getDocumentTypeIcon = (type) => {
    switch (type) {
      case 'Contract':
        return (
          <svg className="w-6 h-6 text-quaternary" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="card hover:border-l-4 hover:border-l-tertiary transition-all duration-200">
      <div className="flex items-start">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-start">
            <h3 className="text-lg font-semibold text-quaternary mb-1">{document.name}</h3>
            <span className={`text-xs font-medium px-2 py-1 rounded-full ${getStatusColor(document.status)}`}>
              {document.status}
            </span>
          </div>
          ...
          <div className="flex justify-between items-center text-sm text-gray-500">
            ...
            <div className="flex space-x-2">
              <button className="text-quaternary hover:text-quaternary/80">
