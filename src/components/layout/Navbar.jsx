      ...
      <div className="flex flex-wrap justify-between items-center">
        <div className="flex items-center">
          ...
          <Link to="/" className="flex items-center">
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-quaternary">LegalAxis</span>
          </Link>
        </div>
          ...
          {isProfileOpen && (
            <div className="absolute top-12 right-4 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow">
              <div className="px-4 py-3">
                ...
                <span className="block text-sm font-medium text-gray-500 truncate">john.doe@legalaxis.com</span>
              </div>
              <ul className="py-1">
                <li>
