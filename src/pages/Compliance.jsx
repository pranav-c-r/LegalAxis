...
const Compliance = () => {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-quaternary">Compliance Guardian</h1>
        <p className="text-gray-600">Monitor and ensure compliance with legal and regulatory requirements.</p>
      </div>
