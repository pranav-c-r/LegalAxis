  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-300 mt-2">Welcome to LegalAxis, your AI-powered legal co-pilot.</p>
      </div>
