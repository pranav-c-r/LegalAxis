...
const Negotiation = () => {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-quaternary">Negotiation Strategist</h1>
        <p className="text-gray-600">Generate counter-proposals and negotiation strategies based on contract analysis.</p>
      </div>
      
      <div className="card">
        <h2 className="section-title">Negotiation Dashboard</h2>
