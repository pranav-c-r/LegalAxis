...
const Obligations = () => {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-quaternary">Obligation Tracker</h1>
        <p className="text-gray-600">Track and manage contractual obligations and deadlines.</p>
      </div>
      
      <div className="card">
        <h2 className="section-title">Obligations Dashboard</h2>
