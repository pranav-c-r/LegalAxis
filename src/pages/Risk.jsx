...
const Risk = () => {
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-quaternary">Risk & Fairness Analyzer</h1>
        <p className="text-gray-600">Identify and assess contractual risks with interactive heatmaps and scoring.</p>
      </div>
      
      <div className="card">
        <h2 className="section-title">Risk Analysis Dashboard</h2>
